...
# ۰. تنظیمات ثابت
# ═══════════════════════════════════════════════════════════
n_candles = 60          # تغییر از 150 به 60
tf_input = "30m"
search_interval = "1d"
...
for crypto_symbol in crypto_symbols:
    ...
    # بدون آستانه: استفاده از تمام تطابق‌های انتخاب شده
    ...
    plt.suptitle(f'تحلیل الگوی {crypto_symbol} - RSI (بدون آستانه امتیاز)', fontsize=16)
    plt.tight_layout()
